    ...
    <div class="profile-header">
      <div class="profile-avatar-area">
        <n-avatar
          ...
          round
        />
        <n-avatar v-else :size="80" round class="profile-avatar-default">
          {{ authStore.user?.nickname?.charAt(0)?.toUpperCase() || 'U' }}
        </n-avatar>
      </div>
      <div class="profile-info">
        <h2 class="profile-name">{{ authStore.user?.nickname || '用户' }}</h2>
      ...
      <div class="profile-card credits-card">
        ...
        <div class="recharge-section">
          ...
          <div class="recharge-options">
            ...
            >
              <span class="recharge-amount">{{ opt.amount }}</span>
              <span class="recharge-bonus" v-if="opt.bonus">+{{ opt.bonus }}</span>
            </div>
          </div>
          <n-button
            type="primary"
      ...
      <div class="profile-card">
        ...
        <div class="card-body info-list">
          <div class="info-row">
            ...
            <span class="info-value num-mono">{{ authStore.user?.id?.slice(0, 8) }}...</span>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <span class="info-value">{{ authStore.user?.github_id ? '已绑定' : '未绑定' }}</span>
          </div>
        </div>
      </div>
    </div>
...
import {
  NAvatar, NIcon, NInput, NButton, useMessage,
} from "naive-ui";
import {
  DiamondOutline,
  CreateOutline,
