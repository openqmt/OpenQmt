                        ...
                        <div class="panel-body">
                            ...
                            >
                                <span class="index-name">{{
                                    stockConfig[key as StockKey]?.name
                                }}</span>
                                <span
                                    class="index-price num-mono"
                                    :class="priceColor(key as StockKey)"
                                    >{{
                                        formatVal(
                                            store.data[key as StockKey]?.current
                                        )
                                    }}</span
                                >
                                <span
                                    class="index-change num-mono"
                                    :class="priceColor(key as StockKey)"
                                    >{{
                                        formatChange(
                                            store.data[key as StockKey]
                                        )
                                    }}</span
                                >
                            </div>
