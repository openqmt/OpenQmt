            ...
            >
              ...
              <div class="channel-actions">
                ...
                <n-switch
                  ...
                  @update:value="notificationStore.toggleChannel(channel.id)"
                />
              </div>
            </div>
          </div>
            ...
            >
              <div class="notification-header">
                ...
                <n-switch
                  ...
                  @update:value="
                    notificationStore.toggleNotification(notification.type)
                  "
                />
              </div>
              <div class="notification-channels" v-if="notification.enabled">
                ...
                <div class="channels-options">
                  <n-checkbox
                    ...
                    @update:checked="
                      toggleNotificationChannel(notification.type, channel.id)
                    "
                  >
                    {{ channelIcons[channel.type] }}
                    {{ channel.name }}
    ...
    >
      ...
      >
        ...
        <n-form-item
          ...
          path="corpId"
        >
          <n-input v-model:value="channelForm.corpId" placeholder="企业ID" />
        </n-form-item>
        <n-form-item
          v-if="channelForm.type === 'wecom'"
          label="Agent ID"
...
function toggleNotificationChannel(
  ...
  notificationStore.toggleNotificationChannel(
    notificationType,
    channelId as PushChannel,
  );
}
