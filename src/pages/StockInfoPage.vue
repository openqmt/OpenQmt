            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    ><span class="val num-mono">{{
                        data.info.open.toFixed(2)
                    }}</span>
                </div>
                <div class="info-item">
                    <span class="lbl">最高</span
                    ><span class="val num-mono up">{{
                        data.info.high.toFixed(2)
                    }}</span>
                </div>
                <div class="info-item">
                    <span class="lbl">最低</span
                    ><span class="val num-mono down">{{
                        data.info.low.toFixed(2)
                    }}</span>
                </div>
                <div class="info-item">
                    <span class="lbl">成交量</span
                    ><span class="val num-mono">{{
                        fmtVol(data.info.volume)
                    }}</span>
                </div>
                <div class="info-item">
            ...
            <div class="trend-row">
                <div class="trend-item">
                    ...
                    ><span class="trend-val">{{
                        data.diagnosis.shortTrend
                    }}</span>
                </div>
                <div class="trend-item">
                    <span class="trend-lbl">中期趋势</span
                    ><span class="trend-val">{{
                        data.diagnosis.midTrend
                    }}</span>
                </div>
                <div class="trend-item">
                    <span class="trend-lbl">长期趋势</span
                    ><span class="trend-val">{{
                        data.diagnosis.longTrend
                    }}</span>
                </div>
            </div>
        ...
        <div class="surface-card profile-card">
            ...
            <div class="profile-grid">
                ...
                <div class="profile-item">
                    ...
                    ><span class="val num-mono"
                        >{{ data.profile.grossMargin }}%</span
                    >
                </div>
                <div class="profile-item">
                    <span class="lbl">资产负债率</span
                    ><span class="val num-mono"
                        >{{ data.profile.debtRatio }}%</span
                    >
                </div>
                <div class="profile-item">
