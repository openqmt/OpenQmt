...
export function getChartData(key: StockKey, period: ChartPeriod) {
    ...
    const klines = generateKLine(
        key,
        period === 'daily' ? 250 : 200,
        period === 'monthly',
    )
    return {
        intraday: null,
...
const MOCK_A_SHARE_REVIEW: MarketReview = {
    ...
    mainSectors: [
        {
            name: '人工智能',
            reason: '受OpenAI发布新一代模型刺激，国内AI概念股集体走强，算力、数据、应用端全面爆发，龙头股封板带动板块情绪',
        },
        {
            name: '半导体',
            reason: '国产替代逻辑持续强化，设备板块订单超预期，叠加全球芯片库存去化接近尾声，资金持续加仓',
        },
        {
            name: '新能源车',
            reason: '6月新能源车销量数据超预期，智能化渗透率加速提升，产业链龙头业绩预告向好',
        },
    ],
    subSectors: [
        {
            name: '低空经济',
            reason: '政策催化持续，多地出台低空经济产业规划，eVTOL试飞进展顺利，短期情绪推动明显',
        },
        {
            name: '人形机器人',
            reason: '特斯拉Optimus量产预期升温，国内厂商加速布局执行器与传感器环节，题材活跃',
        },
    ],
    positionAdvice:
        '建议仓位6-7成，保持均衡配置，成长方向可适当偏重。关注AI、半导体等主线板块回调后的低吸机会，同时保留部分防御性仓位应对不确定性。',
    strategy:
        '逢低布局主线板块龙头，关注中报业绩超预期标的。短线操作以AI+半导体双主线轮动为主，中线可逢低配置新能源车及消费电子方向。注意控制追高风险，优先选择有业绩支撑的品种。',
    avoidance: [
        '高位连板股（追高风险大）',
        '题材退潮期的纯概念股',
        '业绩预告不达预期的白马股',
...
const MOCK_US_SHARE_REVIEW: MarketReview = {
    ...
    mainSectors: [
        {
            name: 'AI基础设施',
            reason: '虽然短期估值承压，但算力需求持续增长，云厂商资本开支指引上调，长期逻辑未破坏',
        },
        {
            name: '新能源车/智能驾驶',
            reason: '特斯拉FSD V13发布预期升温，自动驾驶立法推进，中国新能源车出口数据强劲',
        },
    ],
    subSectors: [
        {
            name: '生物科技',
            reason: 'GLP-1减肥药赛道持续扩容，多家药企临床数据积极，板块估值修复中',
        },
        {
            name: '网络安全',
            reason: '近期多起重大数据泄露事件推动安全支出预期上调，政策催化明显',
        },
    ],
    positionAdvice:
        '建议美股仓位4-5成，适当降低科技股权重。关注防御性板块如必需消费、医疗保健的配置价值。等待宏观不确定性落地后再考虑加仓。',
    strategy:
        '短期以防守为主，逢高减仓估值偏高的科技龙头。关注AI基础设施回调后的长期布局机会，以及中概股中业绩确定性高的标的。加密货币相关标的波动加剧，建议规避。',
...
const MOCK_HOT_NEWS: HotNewsItem[] = [
    {
        id: 1,
        title: 'OpenAI发布GPT-5模型，推理能力实现重大突破',
        source: '新华网',
        time: '10:25',
        type: 'international',
    },
...
const MOCK_DRAGON_TIGER: DragonTigerItem[] = [
    {
        ...
        sellAmount: 32400,
        netBuy: 52800,
        reason: 'AI算力龙头，机构大额净买入',
        department: '中信证券上海分公司',
    },
    {
        rank: 2,
        stockName: '寒武纪',
    ...
    },
    {
        ...
        sellAmount: 22100,
        netBuy: 32200,
        reason: '新能源车销量超预期，龙头受益',
        department: '华泰证券深圳益田路',
    },
    {
        rank: 4,
        stockName: '北方华创',
    ...
    },
    {
        ...
        sellAmount: 15200,
        netBuy: 20600,
        reason: '人形机器人执行器核心供应商',
        department: '广发证券上海东方路',
    },
    {
        rank: 7,
        stockName: '科大讯飞',
