    ...
    <div class="card-body">
      ...
      <div class="card-footer">
        ...
        <div class="footer-item">
          ...
          <span class="footer-value" :class="passionLevel(passionValuation)">
            {{ passionValuation }}
            <span class="footer-desc">
              {{ valuationDesc(passionValuation) }}
            </span>
          </span>
        </div>
        <div class="footer-item">
          <span class="footer-label">情绪</span>
          <span class="footer-value" :class="passionLevel(passionSentiment)">
            {{ passionSentiment }}
            <span class="footer-desc">
              {{ sentimentDesc(passionSentiment) }}
            </span>
          </span>
        </div>
        <div class="footer-item">
          ...
          >
            {{ passionTemp }}
            <span v-if="passionTemp">°</span>
            <span class="footer-desc"> {{ tempDesc(passionTemp) }} </span>
          </span>
        </div>
      </div>
    </div>
...
const hasPassion = computed(
  () =>
    !!(props.passionTemp || props.passionValuation || props.passionSentiment),
);
