...
最简单的 AI 投资助手 —— 基于 Tauri 2 + Vue 3 构建的跨平台股票分析工具。
...
VITE_FUND_RANK=https://condition.tiantianfunds.com
VITE_FUND_DETAIL=https://dgs.tiantianfunds.com
```
